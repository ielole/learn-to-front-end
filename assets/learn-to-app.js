...
define("learn-to-app/about/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "32QP7dfT", "block": "{\"statements\":[[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n  Welcome, 'three-sixty-five: Resolution Tracker' is designed to help you stay on track to accomplish your\\n  resolutions and goals. Make a resolution or set a goal and add a daily achievement each day for the next 365 days. Add pictures to keep you pumped up and track your progress. What will you achieve in the next 365 days?\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/about/template.hbs" } });
});
...
define("learn-to-app/achievement/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "kAw77iWC", "block": "{\"statements\":[[\"append\",[\"helper\",[\"goal-display/achievement\"],null,[[\"goal\",\"achievement\",\"delete\"],[[\"get\",[\"model\"]],[\"get\",[\"model\"]],\"deleteAchievement\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/achievement/template.hbs" } });
});
...
define("learn-to-app/achievements/new-achievement/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "dV87Axfw", "block": "{\"statements\":[[\"append\",[\"helper\",[\"goal-display/achievement/edit\"],null,[[\"goal\",\"createAchievement\"],[[\"get\",[\"model\"]],\"createAchievement\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/achievements/new-achievement/template.hbs" } });
});
...
define("learn-to-app/components/goal-display/achievement/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Q4xr0HyN", "block": "{\"statements\":[[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"center uno\"],[\"flush-element\"],[\"text\",\"\\n  Daily Achievement:\\n  \"],[\"open-element\",\"h4\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"achievement\",\"log\"]],false],[\"text\",\" \"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  Image url:\\n  \"],[\"open-element\",\"h5\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"achievement\",\"image\"]],false],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"achievement-pic-frame\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"img\",[]],[\"static-attr\",\"class\",\"achievement-pic\"],[\"dynamic-attr\",\"src\",[\"concat\",[[\"unknown\",[\"achievement\",\"image\"]]]]],[\"static-attr\",\"width\",\"300px\"],[\"static-attr\",\"height\",\"300px\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"achievement/update-achievement\",[\"get\",[\"achievement\"]]],null,0],[\"text\",\"  \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-xs btn-danger\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"delete\"]],[\"flush-element\"],[\"text\",\"Delete Daily Achievement\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-xs btn-secondary\"],[\"flush-element\"],[\"text\",\"Update Daily Achievement\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/components/goal-display/achievement/template.hbs" } });
});
...
define("learn-to-app/components/goal-display/achievements-main/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "WP71UYjT", "block": "{\"statements\":[[\"block\",[\"link-to\"],[\"achievement\",[\"get\",[\"achievement\"]]],null,0]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"single-achievement\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"achievement\",\"log\"]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/components/goal-display/achievements-main/template.hbs" } });
});
...
define("learn-to-app/components/goal-display/new-goal/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "3A/yVuS7", "block": "{\"statements\":[[\"open-element\",\"form\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"save\"],[[\"on\"],[\"submit\"]]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"for\",\"goal-name\"],[\"flush-element\"],[\"text\",\"Name of Goal\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"placeholder\",\"value\"],[\"Name of Goal\",[\"get\",[\"newGoal\",\"title\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"for\",\"goal-start-date\"],[\"flush-element\"],[\"text\",\"Start Date\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"placeholder\",\"type\",\"value\"],[\"YYYY-MM-DD HH:MM:SS\",\"date\",[\"get\",[\"newGoal\",\"startDate\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"label\",[]],[\"static-attr\",\"for\",\"goal-end-date\"],[\"flush-element\"],[\"text\",\"End Date\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"placeholder\",\"type\",\"value\"],[\"YYYY-MM-DD HH:MM:SS\",\"date\",[\"get\",[\"newGoal\",\"endDate\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-xs btn-success\"],[\"static-attr\",\"type\",\"submit\"],[\"flush-element\"],[\"text\",\"Save\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/components/goal-display/new-goal/template.hbs" } });
});
define("learn-to-app/components/goal-display/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "8jsdBMLC", "block": "{\"statements\":[[\"open-element\",\"h3\",[]],[\"static-attr\",\"class\",\"goal-title\"],[\"flush-element\"],[\"text\",\"\\n  Goal: \"],[\"append\",[\"unknown\",[\"goal\",\"title\"]],false],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"goal/update-goal\",[\"get\",[\"goal\"]]],null,2],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"h6\",[]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"start dates\"],[\"flush-element\"],[\"text\",\"Start Date: \"],[\"append\",[\"unknown\",[\"goal\",\"startDate\"]],false],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"end dates\"],[\"flush-element\"],[\"text\",\"End Date: \"],[\"append\",[\"unknown\",[\"goal\",\"endDate\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"achievement-word\"],[\"flush-element\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Achievements\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"ul\",[]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"li\",[]],[\"static-attr\",\"class\",\"achievements\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"goal\",\"achievements\"]]],null,1],[\"text\",\"  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"center\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"goal/new-achievement\",[\"get\",[\"goal\"]]],null,0],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"    \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-xs btn-secondary daily-add\"],[\"flush-element\"],[\"text\",\"Add A Daily Achievement\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"      \"],[\"append\",[\"helper\",[\"goal-display/achievements-main\"],null,[[\"achievement\",\"delete\"],[[\"get\",[\"achievement\"]],\"deleteAchievement\"]]],false],[\"text\",\"\\n\"]],\"locals\":[\"achievement\"]},{\"statements\":[[\"text\",\"    \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-xs btn-warning\"],[\"flush-element\"],[\"text\",\"Update Goal\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/components/goal-display/template.hbs" } });
});
...
define("learn-to-app/components/goals-main/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "6skbaRUr", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"all-goals\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"goal\",[\"get\",[\"goal\"]]],null,0],[\"text\",\"  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"h6\",[]],[\"static-attr\",\"class\",\"delete-goal-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"delete\"]],[\"flush-element\"],[\"text\",\"Delete Goal\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"goal-in-list\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"goal\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/components/goals-main/template.hbs" } });
});
...
define('learn-to-app/goal/achievement/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model(params) {
      return this.get('store').findRecord('achievement', params.achievement_id);
    },
...
define("learn-to-app/goal/achievement/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "kOpY1Zgj", "block": "{\"statements\":[[\"append\",[\"helper\",[\"goal-display/achievement\"],null,[[\"goal\",\"achievement\",\"delete\"],[[\"get\",[\"model\"]],[\"get\",[\"model\"]],\"deleteAchievement\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/goal/achievement/template.hbs" } });
});
...
define('learn-to-app/goals/achievement/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model(params) {
      return this.get('store').findRecord('achievement', params.achievement_id);
    },
...
define("learn-to-app/goals/achievement/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "yQOm5zTy", "block": "{\"statements\":[[\"append\",[\"helper\",[\"goal-display/achievement\"],null,[[\"goal\",\"achievement\",\"delete\"],[[\"get\",[\"model\"]],[\"get\",[\"model\"]],\"deleteAchievement\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/goals/achievement/template.hbs" } });
});
...
define("learn-to-app/goals/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "k61f0Rov", "block": "{\"statements\":[[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"goal-word\"],[\"flush-element\"],[\"text\",\"My Goals\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"goals/new-goal\"],null,1],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,0],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"    \"],[\"append\",[\"helper\",[\"goals-main\"],null,[[\"goal\",\"delete\"],[[\"get\",[\"goal\"]],\"deleteGoal\"]]],false],[\"text\",\"\\n\"]],\"locals\":[\"goal\"]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-xs btn-info\"],[\"flush-element\"],[\"text\",\"Create New Goal\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/goals/template.hbs" } });
});
...
define('learn-to-app/index/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
define("learn-to-app/index/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "KVV5dgrV", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"center\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"h2\",[]],[\"static-attr\",\"class\",\"quote\"],[\"flush-element\"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"quote-word\"],[\"flush-element\"],[\"text\",\"Achievement\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  A thing done successfully, typically by effort, courage or skill.\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\" - \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"reference\"],[\"flush-element\"],[\"text\",\"Google Dictionary\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/index/template.hbs" } });
});
...
define("learn-to-app/users/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "3T13qy07", "block": "{\"statements\":[],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "learn-to-app/users/template.hbs" } });
});
/* jshint ignore:start */
...
if (!runningTests) {
  require("learn-to-app/app")["default"].create({"name":"learn-to-app","version":"0.0.0+0cd4db6c"});
}
